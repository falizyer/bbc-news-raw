...
/***/ function(module, exports, __webpack_require__) {
	...
	var _articleList = __webpack_require__(1);
	
	document.addEventListener("DOMContentLoaded", function () {
	    var component = new _articleList.IndexComponent();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bbcNews = __webpack_require__(56);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var IndexComponent = exports.IndexComponent = function IndexComponent() {
	    (0, _classCallCheck3.default)(this, IndexComponent);
	
	    var container = document.getElementsByClassName("article-list").item(0);
	    _bbcNews.BBCNewsRepository.getArticlesMeta("cbf7163e029d46be9533f928a0c9228f").then(function (result) {
	        ...
	        try {
	            for (var _iterator = (0, _getIterator3.default)(articles), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                ...
	                var author = meta.author,
	                    ...
	                    title = meta.title,
	                    url = meta.url,
	                    urlToImage = meta.urlToImage;
	
	                tpl.push("<li class=\"article\"><article>" + ("<figure class=\"image-container\"><img src=\"" + urlToImage + "\" /></figure>") + "<header></header>" + ("<div class=\"content\">" + description + "</div>") + "<footer>" + ("<abbr class=\"author\" title=\"" + author + "\">" + author + "</abbr>") + ("<abbr class=\"published\" title=\"" + publishedAt + "\">" + publishedAt + "</abbr>") + "</footer>" + "</article></li>");
	            }
	        } catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.BBCNewsRepository = undefined;
	...
	var BBCNewsRepositoryClass = function () {
	    function BBCNewsRepositoryClass() {
	        (0, _classCallCheck3.default)(this, BBCNewsRepositoryClass);
	
	        this.url = "https://newsapi.org/v1";
	        this.source = "bbc-news";
	    }
	
	    (0, _createClass3.default)(BBCNewsRepositoryClass, [{
	        key: "getArticlesMeta",
	        value: function getArticlesMeta(apiKey) {
	            ...
	            var response = new Request(this.url + "/articles?source=" + this.source + "&apiKey=" + apiKey, myInit);
	            return fetch(response).then(function (response) {
	                return response.json();
	            });
	        }
	    }]);
	    return BBCNewsRepositoryClass;
	}();
	
	var BBCNewsRepository = exports.BBCNewsRepository = new BBCNewsRepositoryClass();
